                  ...
                  <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
                    ...
                    <div class="carousel-inner">
                      ...
                      <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                          <h5>Gerbang Depan</h5>
                          <p>Sebagai simbol keamanan dan ketertiban, memastikan lingkungan yang aman bagi siswa dan pengunjung.</p>
                        </div>
                      </div>
                      <div class="carousel-item">
                      ...
                      <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                          <h5>Asrama 1</h5>
                          <p>Tempat tinggal yang nyaman dan bersih, menciptakan suasana kekeluargaan bagi siswa dalam menjalani kehidupan sehari-hari.</p>
                        </div>
                      </div>
                      <div class="carousel-item">
                      ...
                      <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                          <h5>Aula</h5>
                          <p>Ruang serbaguna yang digunakan untuk berbagai kegiatan seperti seminar, pertemuan, dan acara keagamaan maupun kebudayaan.</p>
                        </div>
                      </div>
                      <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                          <h5>Lapangan</h5>
                          <p>Area terbuka untuk olahraga dan aktivitas fisik guna menunjang kesehatan dan kebugaran siswa.</p>
                        </div>
                      </div>
                      <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                          <h5>Ruang Belajar</h5>
                          <p>Didesain khusus untuk menciptakan lingkungan belajar yang kondusif, mendukung proses pendidikan yang efektif.</p>
                        </div>
                      </div>
                      <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                          <h5>Dapur</h5>
                          <p>Tempat penyediaan makanan dengan standar kebersihan, memastikan kebutuhan gizi siswa terpenuhi.</p>
                        </div>
                      </div>
                      <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                          <h5>Garasi</h5>
                          <p>Area penyimpanan kendaraan operasional untuk mendukung mobilitas dan kelancaran aktivitas harian.</p>
                        </div>
                      </div>
                      <div class="carousel-item">
                      ...
                      <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                          <h5>Mushola</h5>
                          <p>Tempat ibadah yang nyaman dan bersih, mendukung pembinaan spiritual serta kegiatan keagamaan siswa.</p>
                        </div>
                      </div>
                    </div>
