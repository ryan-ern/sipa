...
@section('content')
    ...
    <div class="row gy-6">
        ...
        <div class="col-md-12 col-lg-6 mb-4">
            <div class="card">
                <div class="card-body text-nowrap">
                    ...
                    <h3 class="text-primary mb-0">$42.8k</h3>
                </div>
        ...
        <div class="col-md-12 col-lg-6 mb-4">
            <div class="card">
                <img src="{{ asset('assets/img/illustrations/piatu.png') }}" class="position-absolute bottom-0 start-0 ms-5"
                    width="90" alt="view sales">
                <div class="card-body text-nowrap text-end">
